...
// const ShowData = ({ patientBioMedList }) => {
//   return (
//     <div>
//       <h2>Saved Patient Data</h2>
//       {patientBioMedList.length > 0 ? (
//         patientBioMedList.map((data, index) => (
//           <div key={index}>
//             <p>Name: {data.name}</p>
//             <p>Birth Date: {data.birthDate}</p>
//             <p>Phone: {data.phoneNumber}</p>
//             <p>Medical Report ID: {data.medReportId}</p>
//             <p>Disease: {data.diseaseName}</p>
//             <p>Description: {data.diseaseDescription}</p>
//           </div>
//         ))
//       ) : (
